...
Partial Public Class XtraReport1
    ...
    Friend WithEvents NwindDataSet1 As BindWinFormsControl.nwindDataSet
    Friend WithEvents CategoriesTableAdapter As BindWinFormsControl.nwindDataSetTableAdapters.CategoriesTableAdapter
